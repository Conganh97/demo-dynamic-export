...
public abstract class ObjectBaseExcelExporter {
    ...
    public ObjectBaseExcelExporter() {
    ...
    public abstract void exportData(List<Object> data, String filePath) throws IOException;
}
